...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT_6x6(
        ...
        KC_LSFT, CTL_Z ,KC_X   , KC_C  , KC_V  , KC_B  ,                                        KC_N   , KC_M  ,KC_COMM, KC_DOT,KC_DOWN,KC_RGHT,
                        KC_RGHT,KC_SPC,                                               CTL_ESC, KC_LEFT, KC_DOWN,
                                        ALT_MENU,KC_LGUI,                      KC_SPC ,
                                            KC_END ,KC_HOME,        KC_RGUI,KC_RSHIFT
