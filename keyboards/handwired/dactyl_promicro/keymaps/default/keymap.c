...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT_6x6(
        ...
        KC_LSFT, CTL_Z ,KC_X   , KC_C  , KC_V  , KC_B  ,                                        KC_N   , KC_M  ,KC_COMM, KC_DOT,KC_SLSH,KC_RSHIFT,
                        KC_RGHT,KC_SPC,                                                           TT(_RAISE), KC_BTN1, KC_BTN2,
                                        ALT_MENU,KC_LGUI,                      KC_BTN3,
                                            KC_END ,KC_HOME,        KC_SPC, KC_RGUI
    ...
    [_RAISE] = LAYOUT_6x6(
        ...
        _______,_______,_______,_______,_______,_______,                                       KC_HOME,KC_BTN1, KC_BTN3,KC_BTN2,KC_END,_______,
        RESET  ,_______,_______,KC_BTN1,KC_BTN2,_______,                                       KC_WBAK,KC_MS_WH_LEFT, KC_DOWN,KC_MS_WH_LEFT,KC_MUTE,_______,
                                                _______,_______,                              _______,_______,_______,
                                                         _______,_______,       _______,
                                                     _______,_______,         _______, _______
    )
